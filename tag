...
parser = argparse.ArgumentParser(description='CBAtags')
parser.add_argument('--tag', '-t', dest='tagtext', default='tag', help='tag identifier')
parser.add_argument(dest='infile', nargs='?', type=argparse.FileType('r'),default=sys.stdin, help='file to translate.  leave blank for STDIN')
args = parser.parse_args()


tags = Tag(args.tagtext)
for line in args.infile:
    print tags.processTags(line)
